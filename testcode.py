...
class Main:
    def __init__(self):
        ...
        def loggedin():
            ...
            self.canvas = CTkCanvas(self.top, width=self.image.width, height=self.image.height, bg="gray")
            self.canvas.grid()
        ...
        def mainmenu():
            ...
            self.canvas = CTkCanvas(self.menu, width=self.image.width, height=self.image.height, bg="gray")
            self.canvas.grid()
            ...
            def view_group_marks(group):
                ...
                self.canvas = CTkCanvas(self.view_marks_window, width=self.image.width, height=self.image.height, bg="gray")
                self.canvas.grid()
            ...
            def view_groups():
                ...
                self.canvas = CTkCanvas(self.groups_window, width=self.image.width, height=self.image.height, bg="gray")
                self.canvas.grid()
            ...
            def addgroupmenu():
                ...
                self.canvas = CTkCanvas(self.addgroups, width=self.image.width, height=self.image.height, bg="gray")
                self.canvas.grid()
                    ...
                    with open("groups.csv", mode="a", newline="") as f:
                        ...
                        def addlearners():
                            ...
                            def addmarks():
                                ...
                                self.canvas = CTkCanvas(self.addmarks, width=self.image.width, height=self.image.height,
                                                        bg="gray")
                                self.canvas.grid()
